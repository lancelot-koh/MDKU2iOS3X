...
- (void) callFunction: (NSDictionary*)params resolve: (SnowblindPromiseResolveBlock)resolve reject: (SnowblindPromiseRejectBlock)reject;
- (NSString*) getPropertyType: (NSDictionary*)params;

...
export class ErrorMessage {
  ...
  public static ODATA_READ_ENTITYSET_NOT_PROVIDED = 'Read failed, entitySet not provided.';
  public static ODATA_COUNT_ENTITYSET_NOT_PROVIDED = 'Count failed, entitySet not provided.';
  ...
  public static ODATA_MANY_TO_ONE_LINKING_NOT_ALLOWED = 
    'Cannot link from {0} using property {1}. many-to-one linking is not possible.';
  ...
  public static ODATA_CREATE_ENTITY_ENTITY_SET_NOT_FOUND = 
    'Create entity failed: entity set {0} does not exist in service';
  ...
  public static ODATA_ENTITYSET_NOT_FOUND = 'EntitySet {0} does not exist';
  ...
  public static ODATA_NO_PARTNERPATH_RETURNED = 
    'Property with name {0} does not participate in any OData Association. Cannot return partnerPath.';
  ...
  public static ODATA_MISSING_PARAMETER_VALUE_FOR_FUNCTION_IMPORT = 'Missing parameter value for Function Import: {0}';
